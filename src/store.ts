...
export const getTemplate = (key: string): Readonly<Template> | undefined => store.templates.get(key);
export const setTemplate = (key: string, value: Template) => store.templates.set(key, value);
export const deleteTemplate = (templateName: string) => store.templates.delete(templateName);
